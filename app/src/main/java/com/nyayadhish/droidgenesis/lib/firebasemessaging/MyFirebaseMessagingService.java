...
package tattvan.com.tattvanpatients.lib.firebasemessaging;
...
/*Check if data needs to be processed by long running job *//*
 false) {
    ...
    private void createNotification(Map<String, String> data) {
            ...
            Log.d(TAG, "createNotification: TYpe = " + data.get("GOTO"));
            switch (data.get(Type.GOTO)) {
                case Type.GOTO:
                    break;
            }
...
/**
    ...
    public void onNewToken(String token) {
        ...
        AppDroidGenesis.FCMToken = token;
    }
    // [END on_new_token]
